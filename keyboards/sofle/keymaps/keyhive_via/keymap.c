...
[2] = LAYOUT(
  ...
  KC_TAB,  KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_PIPE,                    KC_CIRC, KC_UNDS, KC_MINUS,  KC_PLUS,    KC_0,  KC_F12,
  _______, KC_LBRC, KC_RBRC, KC_SLSH, KC_BSLS, KC_HASH,                    KC_CIRC, KC_AMPR,  KC_ASTR, KC_QUOTE, KC_DQUO, _______,
  _______, _______, KC_AT,   KC_PLUS, KC_SCLN, KC_EXLM, _______,  _______, KC_TILD, KC_GRV,   KC_LABK,  KC_RABK, KC_QUES, _______,
